    ...
    render() {
        ...
        return <div>
                <Nav/>
                        ...
                        <div className="forms-cover">
                            <div className="forms-container">
                                <form onSubmit={this.handleSubmit}>
                                    <h3 className="join-free"><strong>Sign Up</strong></h3>
                    ...
                    <div className="signup-cover-bottom">
                        <span className="signup-msg1">START A SPECIAL RELATIONSHIP TODAY</span>
                    </div>
                    <div className="signup-cover-bottom2">
                        <p className="signup-msg2">This dating website was designed by Arnold Zulu. It is part of a Wethinkcode_ curriculum. It was built in: JavaScript, ReactJs, Redux and Firebase. </p>
                    </div>
                <Footer/>  
            </div> 
    }
